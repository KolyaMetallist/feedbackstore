 ...
 */
package com.nabazhenov.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.nabazhenov.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "feedbackstorecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "feedbackstorecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "feedbackstorecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "feedbackstorecommercewebservices.v2.description";
	private static final String TITLE = "feedbackstorecommercewebservices.v2.title";
	private static final String VERSION = "feedbackstorecommercewebservices.v2.version";
	private static final String LICENSE = "feedbackstorecommercewebservices.v2.license";
	private static final String LICENSE_URL = "feedbackstorecommercewebservices.v2.license.url";
