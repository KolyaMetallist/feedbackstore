 ...
 */
package com.nabazhenov.feedbackstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(FeedbackstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(FeedbackstoreFulfilmentProcessConstants.PARENT_PROCESS);
