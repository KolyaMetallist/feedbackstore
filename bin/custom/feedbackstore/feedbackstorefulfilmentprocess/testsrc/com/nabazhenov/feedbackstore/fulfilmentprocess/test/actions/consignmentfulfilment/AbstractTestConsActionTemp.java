 ...
 */
package com.nabazhenov.feedbackstore.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, FeedbackstoreFulfilmentProcessConstants.PARENT_PROCESS);
