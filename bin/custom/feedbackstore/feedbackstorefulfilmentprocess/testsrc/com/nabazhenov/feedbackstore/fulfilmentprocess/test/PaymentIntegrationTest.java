...
import com.nabazhenov.feedbackstore.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/feedbackstorefulfilmentprocess/test/feedbackstorefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/feedbackstorefulfilmentprocess/test/feedbackstorefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/feedbackstorefulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/feedbackstorefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/feedbackstorefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/feedbackstorefulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/feedbackstorefulfilmentprocess/test/feedbackstorefulfilmentprocess-spring-testcleanup.xml"));
