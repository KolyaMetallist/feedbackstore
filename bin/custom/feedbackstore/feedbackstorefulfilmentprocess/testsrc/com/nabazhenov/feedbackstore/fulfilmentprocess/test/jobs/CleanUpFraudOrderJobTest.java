 ...
 */
package com.nabazhenov.feedbackstore.fulfilmentprocess.test.jobs;
...
import com.nabazhenov.feedbackstore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = FeedbackstoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
