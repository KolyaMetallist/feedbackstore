...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/feedbackstorestorefront/electronics/en",
						"https://electronics.local:9002/feedbackstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/feedbackstorestorefront/electronics/en",
						"https://electronics.local:9002/feedbackstorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/feedbackstorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/feedbackstorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/feedbackstorestorefront/electronics/en",
						"https://electronics.local:9002/feedbackstorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/feedbackstorestorefront",
						"https://electronics.local:9002/feedbackstorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/feedbackstorestorefront",
						"https://electronics.local:9002/feedbackstorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/feedbackstorestorefront/electronics/en",
						"https://electronics.local:9002/feedbackstorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
