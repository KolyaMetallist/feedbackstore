...
public class TestSetupUtils
{
	...
	private static void setupCommerce(final BiConsumer<FeedbackstorecommercewebservicestestSetup, SystemSetupContext> triggerEqualsValidator)
	{
		final FeedbackstorecommercewebservicestestSetup setup = getCommerceWebServicesTestSetup();
	...
	private static FeedbackstorecommercewebservicestestSetup getCommerceWebServicesTestSetup()
	{
		return Registry.getApplicationContext().getBean("yCommerceWebServicesTestSetup", FeedbackstorecommercewebservicestestSetup.class);
	}
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		{ "Go" });
		params.put("feedbackstorecommercewebservicestest_sample", new String[]
		{ "true" });
		...
		return new SystemSetupContext(params, Type.ALL, Process.ALL, "feedbackstorecommercewebservicestest");
	}
	...
	{
		if (!Config.getBoolean("feedbackstorecommercewebservicestest.embedded.server.enabled", true))
		{
