...
public class FeedbackstorecommercewebservicestestSetup extends AbstractSystemSetup
{
	public static final String WS_INTEGRATION = "wsIntegrationTest";
	public static final String WS_TEST = "wsTest";
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(FeedbackstorecommercewebservicestestSetup.class);
	...
	{
		return Config.getBoolean("feedbackstorecommercewebservicestest.enableWsIntegrationTest", false);
	}
		...
		if (extensionNames.contains("acceleratorwebservicesaddon"))
		{
			storeNames.forEach(store -> {
				getSetupImpexService().importImpexFile(
						String.format("/feedbackstorecommercewebservicestest/import/acceleratorwebservicesaddon/%s/solr.impex", store), true, true);
				getSetupImpexService().importImpexFile(
						String.format("/feedbackstorecommercewebservicestest/import/acceleratorwebservicesaddon/%s/site.impex", store), true, true);
			});
		}

		if (extensionNames.contains("yacceleratorfulfilmentprocess"))
		{
			getSetupImpexService().importImpexFile("/feedbackstorecommercewebservicestest/import/orderprocess/store.impex", true, true);
		}
	}
	...
	public void initializePromotionEngineModule()
	{
		getSetupImpexService()
				.importImpexFile("/feedbackstorecommercewebservicestest/import/promotionengine/promotionsmodule.impex", true, false);
	}
	...
	protected void loadIntegrationData()
	{
		...
		{
			getSetupImpexService().importImpexFile("/feedbackstorecommercewebservicestest/import/integration/cis-integration-data.impex", true);
		}

		if (extensionNames.contains("omssampledata"))
		{
			getSetupImpexService().importImpexFile("/feedbackstorecommercewebservicestest/import/integration/oms-integration-data.impex", true);
		}
	}
	...
	{
		getSetupImpexService().importImpexFile(
				"/feedbackstorecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-categories.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/feedbackstorecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/feedbackstorecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-prices.impex",
				true, false);
		getSetupImpexService().importImpexFile(
				"/feedbackstorecommercewebservicestest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-stock-levels.impex",
				true, false);
