...
import com.nabazhenov.test.groovy.webservicetests.SSLIssuesIgnoringHttpClientFactory
import com.nabazhenov.test.groovy.webservicetests.config.TestConfigFactory
...
abstract class AbstractSpockTest extends Specification {
	private static String LOG4J_PROPERTIES_CLASS_PATH="feedbackstorecommercewebservicestest/log4j.properties";
	...
	protected static ConfigObject config = TestConfigFactory.createConfig("v2","/feedbackstorecommercewebservicestest/groovytests-property-file.groovy");
	...
	protected static final String getBasePathWithIntegrationSite() {
		def enableWsIntegrationTest = Config.getBoolean("feedbackstorecommercewebservicestest.enableWsIntegrationTest", false);
