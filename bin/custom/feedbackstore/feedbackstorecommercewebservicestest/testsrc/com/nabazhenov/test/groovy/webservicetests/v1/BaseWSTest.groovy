...
import com.nabazhenov.test.groovy.webservicetests.TestNamePrinter
import com.nabazhenov.test.groovy.webservicetests.TestUtil
import com.nabazhenov.test.groovy.webservicetests.config.TestConfigFactory
import com.nabazhenov.test.groovy.webservicetests.docu.BaseWSTestWatcher
...
class BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("feedbackstorecommercewebservicestest.enableV1", false))
	}
	...
	protected BaseWSTest() {
		config = TestConfigFactory.createConfig("v1", "/feedbackstorecommercewebservicestest/groovytests-property-file.groovy");
