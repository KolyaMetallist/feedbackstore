 ...
 */
package com.nabazhenov.feedbackstore.core.constants;

/**
 * Global class for all FeedbackstoreCore constants. You can add global constants for your extension into this class.
 */
public final class FeedbackstoreCoreConstants extends GeneratedFeedbackstoreCoreConstants
{
	public static final String EXTENSIONNAME = "feedbackstorecore";


	private FeedbackstoreCoreConstants()
	{
		//empty
	}
