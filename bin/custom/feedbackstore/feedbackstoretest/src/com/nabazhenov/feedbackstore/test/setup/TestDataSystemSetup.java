 ...
 */
package com.nabazhenov.feedbackstore.test.setup;
...
import com.nabazhenov.feedbackstore.test.constants.FeedbackstoreTestConstants;
import com.nabazhenov.feedbackstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = FeedbackstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/feedbackstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/feedbackstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/feedbackstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/feedbackstoretest/import/csquotes.impex");
		}
	}
}
